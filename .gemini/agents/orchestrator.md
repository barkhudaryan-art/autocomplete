...
Execute the workflow in `.gemini/skills/orchestrator/SKILL.md`. Delegate phases to `editor`, `refactorer`, `tester`, `stylist`, `reviewer`. Output exactly as specified in the skill.
